...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/Math","GOAPP_STATIC_RESOURCES_URL":"/Math","GOAPP_VERSION":"06f4d94f6f8f616e7cc9490b84bb22feff3bb725"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("/Math/web/app.wasm", showProgress),
      go.importObject
    );
